...
(function () {
  ...
  function extract() {
    const name = text('h1.product-name, h1');
    const catalog = text('.product-code, [data-product-code]');
    const sizeEl = document.querySelector('.pack-size, .size-pack');
    ...
    const imageUrl = document.querySelector('.product-image img, img.product')?.src;
